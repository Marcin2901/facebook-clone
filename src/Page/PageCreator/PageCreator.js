...
function PageCreator() {
    ...
    const items = [{elem: <FacebookItem icon={<i class="fas fa-sitemap icon--item"></i>} text={"Meta Business Suite"}/>, ending: "pagesCreator/meta"},
                   {elem: <FacebookItem icon={<i class="fas fa-compass icon--item"></i>} text={"Odkryj"}/>, ending: "pagesCreator/discovery" },
                   {elem: <FacebookItem icon={<i class="fas fa-thumbs-up icon--item"></i>} text={"Polubione strony"}/>, ending: "pagesCreator/likedPages" },
                   {elem: <FacebookItem icon={<i class="fas fa-user-plus icon--item"></i>} text={"Zaproszenia"}/>, ending: "pagesCreator/invitagesPages" }]
    
    const headerELem = <div className="create--page-btn"><i class="fas fa-plus"></i> Utwórz nową stronę</div>
